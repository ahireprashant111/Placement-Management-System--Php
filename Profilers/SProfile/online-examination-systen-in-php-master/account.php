...
<h3><b><center>First Round</center></b></h3>
<!--home start-->
<?php if(@$_GET['q']==1) {

$result = mysqli_query($con,"SELECT * FROM quiz Where tag = 'PHP' ORDER BY date DESC") or die('Error');
...
if ($w >= 2) {
  ...
  ?>
  <h3>Congratulations,click here to next round <a class="btn btn-success" href="second/account.php" role="button">Second Round</a><br><br></h3>
  <style>
    h3{
      font-size: 22px; 
      color: gray;
