...
<div class="row">
<div class="col-md-12">
<h3><b><center>Second Round</center></b></h3>
<!--home start-->
<?php 

$result = mysqli_query($con,"SELECT * FROM quiz Where tag = 'c++' ORDER BY date DESC") or die('Error');
...
if ($w >= 1) {
  ?>
  <h3>You are not able to proceseed further <a class="btn btn-danger" href="../../logout.php" role="button">Signout</a></h3>
  <?php
}
else{
  ?>
  <h3>Congratulations,You successfully passed second round <a class="btn btn-success" href="interview1.php" role="button">Go For Interview </a><br><br></h3>
  <style>
    h3{
      font-size: 22px; 
      color: gray;
