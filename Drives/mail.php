				...
				<div class="top-nav">
					...
					<ul class="nav1">
						<li class="hvr-sweep-to-bottom">
								<a href="../Homepage/home.php">SIOM <i>Goto Placement Homepage</i></a>
							</li>
						<li class="hvr-sweep-to-bottom">
		...
		<div class="container">
			...
			<div class="mail-grids">
				<div class="col-md-6 mail-grid-left wow fadeInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h3>Contact Us</h3>	
					<p></p>				
					<h4>Sinhgad Institute of Technology</h4>
					<p>Vadgaon Budruk,
						<span>Pune,Maharashtra</span>
						India
					</p>
					<h4>Get In Touch</h4>
					<p>Telephone: +91 8793233096
						<span>FAX: +91 8793233096</span>
						E-mail:siom@gmail.com</a>
					</p>
				</div>
	...
	<!-- footer -->
		<div class="footer">
			...
			<div class="container">
				...
				<div class="col-md-3 footer-middle wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					...
					<div class="address">
						<p>SIOM
							<span>Sinhgad Rd, Vadgaon Budruk, Pune</span>
						</p>
					</div>
					<div class="phone">
						<p>1234567890</p>
				...
				<div class="col-md-3 footer-right  wow fadeInRight animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h6 style="color: white">Sinhgad Institute of Technology</h6>
					<h4>
		...
		<div class="copyright">
			...
			<div class="container">
              ...
              <a href="http://znumerique.azurewebsites.net" target="_parent">Prashant Technologies</a>
				</div>
