            ...
            <div class="header-content">
                <div class="header-content-inner">
                    ...
                    <p>We are here to Build your Skills and Career with our Driven Passion and Reality.</br>Click Below to Get Our Current Drive
                        Details</p>
                    <a href=" ../Profilers../PProfile/Placement Drives/viewCompanydetails.php" class="btn btn-primary btn-xl page-scroll">Current Drives</a>
                </div>
            </div>
        </header>
        <div class="footer">
			<div class="container">
				...
				<div class="col-md-3 get_in_touch ftr">
					...
					<p>India</p>
					<p>8793233096</p>
					<a href="mailto:ahireprashant111@gmail.com">ahireprashant111@gmail.com</a>
				</div>
				<div class="col-md-3 ftr-logo">
					<p>Copyright &copy;Prashant Technologies
				</div>
